...
<head>
  ...
  /* Styles for screens up to 768px wide (tablets) */
}

@media screen and (max-width: 576px) {
  /* Styles for screens up to 576px wide (mobile devices) */
}
...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand text-warning custom-text-color company-name" href="#">
            <img src="Images/ELOGO.png" alt="" class="d-inline-block align-top">
            <span class="company-name-text">Employee Salary Management System</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active text-white" aria-current="page" href="Admindashbord.jsp">Home</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">PayRoll Processing</a></li>
                        <li><a class="dropdown-item" href="#">Salary Structure Management</a></li>
               ...
               <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="EmployeeLogin.jsp">Employee</a></li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    <h1 id="clients"><marquee scrollamount="20">Employee Salary Management System</marquee></h1>
                </div>
            </div>
            <div class="carousel-item">
                <img src="Images/HomeImage2.jpg" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1 id="clients"><marquee scrollamount="20">Employee Salary Management System</marquee></h1>
                </div>
            </div>
...
<p>Our clients include some of the top Fortune 500 companies, innovative startups, and dynamic small businesses. We strive to provide each of our clients with tailored solutions that meet their unique needs and help them achieve their business goals.</p>
...
<section class="py-3 py-md-5 py-xl-8 bg-light">
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <p class="text-secondary mb-5 text-center">Our clients are the backbone of our business. We are proud to work with a wide range of companies, from small businesses to Fortune 500 enterprises.</p>
  ...
  <div class="container overflow-hidden bg-color:primary">
    <div class="row gy-5">
...
<!-- Footer -->
<footer class="text-center text-lg-start bg-gray text-white">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3"></i>Employee  Management 
          </h6>
          <p>
            Here we provide all services which useful for you
          </p>
          <a href="https://www.linkedin.com/in/rushikesh-patil12 "><img src="Images/Linkedin.png" style="width:50px;height:50px;margin-left:20px;"/></a>
           <img src="Images/Instagram.png" style="width:50px;height:50px;margin-left:40px;"/>
           <br><br>
            <img src="Images/whatsup.png" style="width:50px;height:50px;margin-left:20px;"/> 
            <img src="Images/Browser.png" style="width:50px;height:50px;margin-left:40px;"/>
        </div>
        <!-- Grid column -->

        <!-- Grid column -->
        <!-- Section: Links  -->
<section class="footer-links text-center text-lg-start bg-light text-muted">
  ...
  <div class="container text-center text-md-start mt-5">
    <div class="row mt-3">
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
          <a href="#!" class="text-blue">Angular</a>
        </p>
        <p>
          <a href="#!" class="text-blue">React</a>
        </p>
        <p>
          <a href="#!" class="text-blue">JavaScript</a>
        </p>
        <p>
          <a href="#!" class="text-blue">MySQL</a>
        </p>
      </div>
      <!-- Grid column -->
      ...
      <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
          <a href="#!" class="text-blue">Pricing</a>
        </p>
        <p>
          <a href="#!" class="text-blue">Settings</a>
        </p>
        <p>
          <a href="#!" class="text-blue">Orders</a>
        </p>
        <p>
          <a href="#!" class="text-blue">Help</a>
        </p>
      </div>
      <!-- Grid column -->
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <p><i class="fas fa-home me-3"></i> Baner, NY 10012, Pune</p>
        <p>
...
<div class="text-center p-4 bg-light text-dark">
  © 2021 Copyright:
  <a class="text-reset fw-bold" href="https://mdbootstrap.com/">Employee.com</a>
</div>
